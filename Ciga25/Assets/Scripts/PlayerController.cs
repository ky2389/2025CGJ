...
public class PlayerController : MonoBehaviour
{
    ...
    public void PrintAnimationState()
    {
        if (animator == null) return;

        bool isPushing = animator.GetBool("IsPushing");
        bool facingUp = animator.GetBool("FacingUp");
        bool facingDown = animator.GetBool("FacingDown");
        bool facingLeft = animator.GetBool("FacingLeft");
        bool facingRight = animator.GetBool("FacingRight");

        Debug.Log($"[Player Animation State] IsPushing: {isPushing}, FacingUp: {facingUp}, FacingDown: {facingDown}, FacingLeft: {facingLeft}, FacingRight: {facingRight}");
    }
